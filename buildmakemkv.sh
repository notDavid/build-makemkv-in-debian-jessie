...
echo -e "\e[34mmkdir -p ~/tmp && docker run -t -i -v ~/tmp:/data docker-makemkv bash"
echo "#2. in the docker container, execute: "
echo -e "\e[34mcp ~/makemkv_sources/makemkv-oss-*/makemkv-oss_*.deb /data/"
echo -e "\e[34mcp ~/makemkv_sources/makemkv-bin-*/makemkv-bin_*.deb /data/"
echo -e "\e[34mexit"
echo "#3. on the host, you can now install makemkv by running:"
echo -e "\e[34mdpkg -i ~/tmp/makemkv-oss_*.deb && dpkg -i ~/tmp/makemkv-bin_*.deb"
